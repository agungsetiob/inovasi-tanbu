...
@section('content')
    @fragment('edit-evaluasi')
        <div class="container-fluid slide-it" id="app">
            <div class="d-sm-flex align-items-center justify-content-between mb-4">
                <h1 class="h3 mb-0 text-dark">Edit Evaluasi</h1>
            </div>
            <div class="row">
                            ...
                            <form action="{{ route('evaluasi.update', $evaluasi->id) }}" method="POST" enctype="multipart/form-data"
                                ...
                                <div class="form-group">
                                    ...
                                    <input id="judul" type="text" class="form-control @error('judul') is-invalid @enderror"
                                        name="judul" value="{{ old('judul', $evaluasi->judul) }}" placeholder="Masukkan judul evaluasi">
                                    @error('judul')
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea id="deskripsi"
                                        ...
                                        placeholder="Masukkan deskripsi evaluasi">{{ old('deskripsi', $evaluasi->deskripsi) }}</textarea>
                                    @error('deskripsi')
                                        <div class="alert alert-danger mt-2">
                                            {{ $message }}
                                        </div>
                                        ...
                                        <div class="col">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input id="uploadFile" type="text"
                                                    ...
                                                    placeholder="Choose a photo" value="{{ $evaluasi->foto }}">
                                            </div>
                                            @error('foto')
                                                <div class="alert alert-danger mt-2">
                                                    {{ $message }}
                                            ...
                                            @if ($evaluasi->foto)
                                                <div class="mt-2">
                                                    <img src="{{ asset('storage/' . $evaluasi->foto) }}" width="200" alt="Current Photo">
                                                </div>
                                            @endif
                                        </div>
                                        <div class="col">
                                            <label class="font-weight-bold" for="link">Link:</label>
                                            <input id="link" type="text" value="{{ old('link', $evaluasi->link) }}"
