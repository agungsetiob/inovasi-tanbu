                                    ...
                                    <form action="{{ route('inovasi.store') }}" method="POST" enctype="multipart/form-data" hx-history="false">
                                        ...
                                        <div id="test-l-2" role="tabpanel" class="bs-stepper-pane" aria-labelledby="stepper1trigger2">
                                            <div class="form-group">
                                                ...
                                                <input id="desc" type="text" class="form-control @error('deskripsi') is-invalid @enderror" name="deskripsi" value="{{ old('deskripsi') }}" placeholder="Deskripsi singkat inovasi">
                                                @error('deskripsi')
                                                    <div class="alert alert-danger mt-2">
                                                        {{ $message }}
                                                    </div>
