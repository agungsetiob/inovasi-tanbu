...
<body id="page-top" class="slide-on" hx-ext="loading-states">
  ...
  <div id="wrapper">
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <!-- Main Content -->
      <div id="content" @foreach ($backgrounds as $background) style="background: url('{{url("storage/backgrounds/" . $background->background)}}'); background-position: center; background-repeat: no-repeat; background-size:
      cover;" @endforeach>
      ...
      <nav class="navbar navbar-expand navbar-light bg-gradient-primary topbar mb-4 shadow">
        ...
        <ul class="navbar-nav ml-auto">
          ...
          <li class="nav-item dropdown no-arrow" id="userMenuContainer">
            ...
            class="fa fa-caret-down text-white mr-1"></i>
