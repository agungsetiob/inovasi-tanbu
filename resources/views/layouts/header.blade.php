...
<body id="page-top" class="slide-on" hx-ext="loading-states">
    <div id="wrapper">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            <div id="content" @foreach ($backgrounds as $background)
                style="background: url('{{url("storage/backgrounds/" . $background->background)}}'); background-position: center; background-repeat: no-repeat; background-size: cover;"
            @endforeach>
                <nav class="navbar navbar-expand navbar-light bg-gradient-primary topbar mb-4 shadow">
                    ...
                    <ul class="navbar-nav ml-auto">
                        <li class="nav-item no-arrow">
                            <a class="nav-link text-warning" href="{{ url('assets/manual-book-serasi.pdf') }}"
                                target="_blank">
                                Manual book
                            </a>
                        </li>
            ...
            <a class="floating-wa-button" href="https://wa.me/{{$telp}}" target="_blank"
                ...
                <i class="fa-brands fa-square-whatsapp fa-3x text-wa"></i>
            </a>
            <x-footer />
        </div>
    </div>
